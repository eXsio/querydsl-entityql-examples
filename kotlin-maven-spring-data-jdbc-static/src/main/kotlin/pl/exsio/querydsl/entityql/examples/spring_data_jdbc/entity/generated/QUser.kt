 ...
 */
 ...
 class QUser : QStaticModel<User<*>> {
     ...
     val typeStr: QEnumPath <UserTypeByName> = run {
         val config = QPathConfig(UserTypeByName::class.java, Enum::class.java, "TYPE_STR", true, 4, 12)
     ...
     val typeOrd: QEnumPath <UserTypeByOrdinal> = run {
         val config = QPathConfig(UserTypeByOrdinal::class.java, Enum::class.java, "TYPE_ORD", true, 5, 12)
