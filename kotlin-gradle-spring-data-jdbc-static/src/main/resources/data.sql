...
create table USERS (USER_ID bigint not null, CREATED_AT date, CREATED_BY varchar(15), NAME varchar(255), TYPE_ORD integer not null, TYPE_STR varchar(255) not null, ENABLED boolean not null, primary key (USER_ID))
...
INSERT INTO USERS (USER_ID, NAME, TYPE_STR, TYPE_ORD, CREATED_BY, CREATED_AT, ENABLED) VALUES (1, 'U1', 'ADMIN', 0, 'ADMIN', now(),true)
INSERT INTO USERS (USER_ID, NAME, TYPE_STR, TYPE_ORD, CREATED_BY, CREATED_AT, ENABLED) VALUES (2, 'U2', 'CLIENT', 1, 'ADMIN', now(),true)
INSERT INTO USERS (USER_ID, NAME, TYPE_STR, TYPE_ORD, CREATED_BY, CREATED_AT, ENABLED) VALUES (3, 'U3', 'CLIENT', 1, 'ADMIN', now(),true)
