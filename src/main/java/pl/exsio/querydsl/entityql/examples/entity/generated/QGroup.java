...
public final class QGroup extends QBase<pl.exsio.querydsl.entityql.examples.entity.Group> {
  ...
  public Q<pl.exsio.querydsl.entityql.examples.entity.Group> dynamic() {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.Group.class);
  }

  public Q<pl.exsio.querydsl.entityql.examples.entity.Group> dynamic(String variable) {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.Group.class, variable);
  }
}
