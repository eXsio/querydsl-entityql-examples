...
public final class QCompositePk
    extends QBase<pl.exsio.querydsl.entityql.examples.entity.CompositePk> {
  ...
  public final PrimaryKey<pl.exsio.querydsl.entityql.examples.entity.CompositePk> _primaryKey;
  ...
  public QCompositePk(String variable) {
    super(
        pl.exsio.querydsl.entityql.examples.entity.CompositePk.class, variable, "", "COMPOSITE_PK");
    ...
    _primaryKey:
    {
      ...
      this._primaryKey =
          this.<pl.exsio.querydsl.entityql.examples.entity.CompositePk>createPrimaryKey(
  ...
  public Q<pl.exsio.querydsl.entityql.examples.entity.CompositePk> dynamic() {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.CompositePk.class);
  }

  public Q<pl.exsio.querydsl.entityql.examples.entity.CompositePk> dynamic(String variable) {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.CompositePk.class, variable);
  }
}
