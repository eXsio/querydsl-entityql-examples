...
public final class QUserGroup extends QBase<pl.exsio.querydsl.entityql.examples.entity.UserGroup> {
  ...
  public final ForeignKey<pl.exsio.querydsl.entityql.examples.entity.Group> group;

  public final ForeignKey<pl.exsio.querydsl.entityql.examples.entity.User> user;

  public final PrimaryKey<pl.exsio.querydsl.entityql.examples.entity.UserGroup> _primaryKey;
  ...
  public QUserGroup(String variable) {
    super(pl.exsio.querydsl.entityql.examples.entity.UserGroup.class, variable, "", "USERS_GROUPS");
    ...
    {
      this.group =
          this.<pl.exsio.querydsl.entityql.examples.entity.Group>createForeignKey(
    ...
    _primaryKey:
    {
      ...
      this._primaryKey =
          this.<pl.exsio.querydsl.entityql.examples.entity.UserGroup>createPrimaryKey(
  ...
  public Q<pl.exsio.querydsl.entityql.examples.entity.UserGroup> dynamic() {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.UserGroup.class);
  }

  public Q<pl.exsio.querydsl.entityql.examples.entity.UserGroup> dynamic(String variable) {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.UserGroup.class, variable);
  }
}
