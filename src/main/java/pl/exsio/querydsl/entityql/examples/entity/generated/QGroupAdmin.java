...
public final class QGroupAdmin
    extends QBase<pl.exsio.querydsl.entityql.examples.entity.GroupAdmin> {
  ...
  public Q<pl.exsio.querydsl.entityql.examples.entity.GroupAdmin> dynamic() {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.GroupAdmin.class);
  }

  public Q<pl.exsio.querydsl.entityql.examples.entity.GroupAdmin> dynamic(String variable) {
    return EntityQL.qEntity(pl.exsio.querydsl.entityql.examples.entity.GroupAdmin.class, variable);
  }
}
